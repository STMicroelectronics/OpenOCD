...
#define ARMV7M_FP_REGS_IDX (ARMV7M_S0)

#define ARMV8M_REGS_IDX (ARMV8M_MSP_NS)
#define ARMV8M_REGS_END (ARMV8M_CONTROL_NS)
#define ARMV8M_REGS_COUNT (ARMV8M_REGS_END - ARMV8M_REGS_IDX + 1)
